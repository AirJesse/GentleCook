		...
		function showComments(obj){
			...
			$.get("cook/getcookcomments.pub",{
				...
				for(var i in comments){
					...
					var $commentDiv = $("<div class='comment'><h4 class='comment-user'></h4><h5 class='comment-date'></h5> <h5 class='comment-type'></h5> <pre class='comment-content'></pre></div>");
					if(comment.type){
					...
					$commentDiv.find(".comment-date").html(comment.crateDate);
